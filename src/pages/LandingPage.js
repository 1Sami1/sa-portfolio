  ...
  return (
    <div className='lp-wrapper'>
      ...
      <section className='about-sec'>
        <h1 className='about-sec-h1'>About</h1>
        <p className='about-sec-p'>I'm Sami! I am a Front-End Developer based in Vancouver, BC.<br/> I take pride in creating [ADJECTIVE] designs! </p>
